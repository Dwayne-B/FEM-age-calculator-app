...
Array.from(inputData).map((input)=>{
    input.addEventListener("change", (e)=>{
        ...
        if (e.target.name === "day") day = e.target.value - 1;
        else if (e.target.name === "month") month = e.target.value - 1;
        else if (e.target.name === "year") year = e.target.value;
        console.log(year, month, day);
        if (year && month >= 0 && day >= 0) {
            currentAge.getAge(year, month, day);
            console.log(currentAge.CalculatedAge);
        }
    });
});
const currentAge = {
    ...
    getAge (year = 2022, month = 1, day = 1) {
        let myYears = (0, _dateFns.differenceInYears)(new Date(), new Date(year, month, day));
        let myMonths = (0, _dateFns.differenceInCalendarMonths)(new Date(), new Date(year, month, day));
        let myDays = (0, _dateFns.differenceInCalendarDays)(new Date(), new Date(year, month, day));
        this.CalculatedAge.years = myYears;
        this.CalculatedAge.months = myMonths;
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iNGHL","1Z4Rq"], "1Z4Rq", "parcelRequire0a17")
