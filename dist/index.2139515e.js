...
})({"7uDTj":[function(require,module,exports) {
...
},{}],"eDgaE":[function(require,module,exports) {
...
const myYearsText = document.querySelector(".my-years");
const myMonthsText = document.querySelector(".my-months");
const myDaysText = document.querySelector(".my-days");
    ...
    input.addEventListener("change", async (e)=>{
        ...
        if (target) {
            if (target.name === "day") {
                ...
                if (parseInt(target.value) > 12 || parseInt(target.value) < 1) errorState();
                else month = parseInt(target.value) - 1;
            } else if (target.name === "year") {
                if (parseInt(target.value) < 1200 || parseInt(target.value) > currentYear) errorState();
                else year = parseInt(target.value);
            }
        }
...
const currentAge = {
    ...
    getAge (year, month, day) {
        let myYears = (0, _dateFns.differenceInYears)(new Date(), new Date(year, month, day));
        /****
     * Get diff b/w next years 
     * birthday and current date
     *  in months
     * */ let myMonths = (0, _dateFns.differenceInCalendarMonths)(new Date(currentYear + 1, month, day), new Date());
        /****
         * Get How many days its been since the number
         * day my birthday falls on
     * */ let myDays = (0, _dateFns.differenceInCalendarDays)(new Date(), new Date(currentYear, new Date().getMonth(), day));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"adZXy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2tncr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7uDTj","eDgaE"], "eDgaE", "parcelRequire0a17")
